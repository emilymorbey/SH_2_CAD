...
Intermediate_Johns <- read.table(file="/rfs/project/rfs-mpB3sSsgAn4/Studies/People/Emily/Proxies/F_SHBG/merged_F_SHBG_DBP_proxies_r06.txt", head=TRUE, sep="\t", row.names=NULL)
...
Outcome_data <- read.table(file="/rfs/project/rfs-mpB3sSsgAn4/Studies/People/Emily/GWAS_outputs/DBP_GWAS_CHR_BP.txt", head=T, sep="\t", row.names=NULL)
...
write.table(out_data, file="/rfs/project/rfs-mpB3sSsgAn4/Studies/People/Emily/Proxies/F_SHBG_DBP_r06.txt", sep="\t", quote=FALSE, row.names=FALSE, col.names=TRUE)
