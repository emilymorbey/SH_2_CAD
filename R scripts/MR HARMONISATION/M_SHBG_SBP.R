...
M_SHBG_proxies_output <- read_excel("not found inputs/SNPs_M_SHBG_AND_SBP.xlsx", sheet = "T&P E&O")
M_SHBG_proxies_output <- M_SHBG_proxies_output[-1,]


allele_matching <- select(M_SHBG_proxies_output, "CHR", "BP", "SNP.x", "ALLELE1", "ALLELE0", "A1FREQ", "BETA", "SE", "Allele1", "Allele2", "Freq1", "Effect", "StdError" )
...
M_SHBG_proxies_output$StdError <- as.numeric(M_SHBG_proxies_output$StdError)
IVW_weights <- M_SHBG_proxies_output$StdError^-2 
