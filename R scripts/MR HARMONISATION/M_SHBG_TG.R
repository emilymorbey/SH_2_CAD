...
M_SHBG_proxies_output <- read_excel("not found inputs/SNPs_M_SHBG_AND_TG.xlsx", sheet = "T&P E&O")
...
allele_matching <- head(allele_matching, -3)
M_SHBG_proxies_output <- head(M_SHBG_proxies_output, -3)
