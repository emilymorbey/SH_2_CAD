...
setwd("/rfs/project/rfs-mpB3sSsgAn4/Studies/People/Emily/Testosterone_CAD_MR/Proteomics/OL_Biobank/Males") # nolint
...
write.table(olink_hits, file="/rfs/project/rfs-mpB3sSsgAn4/Studies/People/Emily/Testosterone_CAD_MR/Proteomics/OL_Biobank/Males/Male_OL_Biobank_T_MR.txt", sep="\t", quote=FALSE, row.names=FALSE, col.names=TRUE)